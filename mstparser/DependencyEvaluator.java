...
public class DependencyEvaluator {
    ...
    public static void evaluate(String act_file, String pred_file) throws IOException {
        ...
        pred_in.readLine();
        pred_in.readLine();
        String act_lab = labeled ? act_in.readLine().trim() : "";
        String act_dep = act_in.readLine().trim();
        String pred_lab = labeled ? pred_in.readLine().trim() : "";
        String pred_dep = pred_in.readLine().trim();
        act_in.readLine();
        pred_in.readLine();
        ...
        while (act_dep != null) {
            ...
            if (act_deps.length != pred_deps.length) System.out.println("Lengths do not match");
            ...
            pred_in.readLine();
            pred_in.readLine();
            act_lab = labeled ? act_in.readLine() : "";
            act_dep = act_in.readLine();
            pred_lab = labeled ? pred_in.readLine() : "";
            pred_dep = pred_in.readLine();
            act_in.readLine();
            pred_in.readLine();
        }
